...
import psycopg2
libpq_path = os.path.join(os.path.dirname(psycopg2.__file__), '..', 'psycopg2_binary.libs', 'libpq-2c01e3753ccf0ab29f038d1bd2d7989e.dll')
libpq_path = os.path.normpath(libpq_path)
