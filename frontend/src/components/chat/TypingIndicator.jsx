    ...
    <div className="flex w-full justify-start mb-6">
      ...
      <div className="flex flex-col max-w-[85%] items-start">
        ...
        <div className="flex items-center gap-2 mb-1.5 text-[11px] text-slate-400 dark:text-slate-500 font-bold px-1 tracking-wide">
          <span className="text-slate-700 dark:text-slate-300">Sylia</span>
          <span className="text-blue-600 dark:text-blue-400 animate-pulse font-semibold">escribiendo...</span>
        </div>

        {/* Bubble */}
        <div className="px-5 py-4 shadow-sm bg-white dark:bg-[#131A2C] border border-slate-200 dark:border-slate-800/80 rounded-3xl rounded-tl-sm flex items-center gap-1.5 h-[52px]">
          <motion.div
