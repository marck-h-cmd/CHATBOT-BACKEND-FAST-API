...
import { Mail, ArrowLeft, ShieldCheck, AlertCircle, RefreshCw, CheckCircle, Sun, Moon } from 'lucide-react';
      ...
      <div className="w-full lg:w-[58%] flex items-center justify-center p-6 sm:p-10 relative bg-white dark:bg-[#0B0F19] overflow-y-auto no-scrollbar transition-colors duration-200">
        ...
        >
          ...
          <div className="lg:hidden flex items-center justify-between mb-2">
            <Link to="/register" className="w-9 h-9 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 shadow-sm hover:bg-slate-100 dark:hover:bg-slate-750 transition-colors">
          ...
          <div className="space-y-1.5 text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-xs font-semibold leading-relaxed">
              Ingresa el código de 6 dígitos enviado a <span className="text-slate-900 dark:text-white font-bold">{email}</span>
            </p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {successMessage && (
              ...
              >
                <div className="p-3.5 rounded-xl bg-blue-50/80 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800/50 flex items-start gap-2.5">
                  <Mail className="w-4.5 h-4.5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" />
                  <div className="space-y-0.5">
                    <h4 className="text-[10px] font-bold text-blue-950 dark:text-red-200">Código enviado</h4>
                    <p className="text-[10px] text-blue-700 dark:text-blue-400 font-medium leading-relaxed">{successMessage}</p>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {error && (
              ...
              >
                <div className="p-3.5 rounded-xl bg-red-50/80 dark:bg-red-950/20 border border-red-200 dark:border-red-800/50 flex items-start gap-2.5">
                  ...
                  <div className="space-y-0.5">
                    <h4 className="text-[10px] font-bold text-red-950 dark:text-red-200">Error de verificación</h4>
            ...
            <div className="flex justify-center gap-2 sm:gap-3">
              {otp.map((digit, index) => (
                <input
                  ...
                  disabled={loading}
                  className="w-12 h-14 sm:w-14 sm:h-16 text-center text-xl sm:text-2xl font-bold text-slate-900 dark:text-white bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-xl focus:outline-none focus:border-blue-600 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/30 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                />
              ))}
            </div>
