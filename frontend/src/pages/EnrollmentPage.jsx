      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="bg-white dark:bg-[#131A2C] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden flex flex-col h-[500px] transition-colors duration-200">
            <div className="p-5 border-b border-slate-105 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 flex justify-between items-center shrink-0">
              <h2 className="font-bold text-slate-808 dark:text-white flex items-center gap-2">
                <BookOpen className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                Cursos Disponibles
              </h2>
              <span className="text-xs font-semibold bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-2.5 py-1 rounded-md text-slate-500 dark:text-slate-400">
                  ...
                  <div
                    ...
                    className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${
                      selectedCourse === course.id_curso
                        ? 'border-indigo-500 dark:border-indigo-550 bg-indigo-50/50 dark:bg-indigo-950/20 shadow-sm'
                        : 'border-slate-100 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 hover:border-indigo-300 dark:hover:border-indigo-800'
                    }`}
                  >
